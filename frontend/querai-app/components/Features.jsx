      ...
      >
        {FEATURES.map(({ title, desc, Icon }, idx) => (
          <motion.div
            ...
            className="group relative overflow-hidden rounded-2xl p-[1px] bg-gradient-to-br from-blue-500/20 to-indigo-500/20 transition-all hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(0,0,0,0.08)]"
          >
            <div className="relative rounded-[calc(theme(borderRadius.2xl)-1px)] border border-slate-200/50 bg-white/70 p-6 shadow-sm backdrop-blur-md">
              {/* Soft gradient sheen */}
              <div className="pointer-events-none absolute inset-0 rounded-[inherit] bg-gradient-to-br from-indigo-50/60 to-transparent" />
